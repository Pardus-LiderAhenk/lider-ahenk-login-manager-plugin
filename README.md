# lider-ahenk-login-manager-plugin
...
1. Clone the plugin project by running `git clone https://github.com/Pardus-LiderAhenk/lider-ahenk-login-manager-plugin.git`.
