package tr.org.liderahenk.loginmanager.commands;
...
public class LoginManagerCommand implements ICommand {

	private Logger logger = LoggerFactory.getLogger(LoginManagerCommand.class);
